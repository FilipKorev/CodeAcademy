...
shoppingList.splice(1,1,"Bannanas","Eggs");
shoppingList.pop();
console.log(shoppingList);
shoppingList.sort();
console.log(shoppingList.indexOf("Milk"));
let indexOfBannanas = shoppingList.indexOf("Bannanas");
shoppingList.splice(indexOfBannanas + 1,0,"Carrots","Lettuce");
console.log(shoppingList);
let shoppingList1 = ["Juice", "Pop"];
let shoppingList2 = shoppingList.concat(shoppingList1, shoppingList1);
